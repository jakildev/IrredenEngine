...
- 2026-09-21: the matrix's sweep arm starts half a step off the cardinals. A
  sweep that lands on them measures the crossing hitch and the update
  catch-up, a whole quadrant at 4× frames, and not rotation; it stays a named
