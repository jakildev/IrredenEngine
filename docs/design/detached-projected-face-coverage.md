...
implementations are mirrored. This slice claims visual correctness at the tested
trixel resolution, not throughput improvement; per-canvas election/candidate cost
