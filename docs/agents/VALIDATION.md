...
| Whitespace | no trailing whitespace, space-before-tab, blank line at EOF or conflict marker on the lines a branch adds, in any file class | `git diff --check origin/master...HEAD` | whitespace.yml on every PR |
