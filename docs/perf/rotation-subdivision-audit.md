...
4. Reduce repeated per-axis storage/overflow/finalization work using the measured
   counters. Preserve finite geometry, trixel reconstruction and depth ordering;
