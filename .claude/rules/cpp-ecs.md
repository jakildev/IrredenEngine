...
See [`engine/prefabs/CLAUDE.md` — Component method rules](../../engine/prefabs/CLAUDE.md#component-method-rules) — canonical home for the (a)/(b)/(c) categorization and documented exceptions.
