 ...
 * File: \irreden-engine\src\game_components\component_gravity_3d.hpp
...
#include "../game_components/component_direction.hpp"
#include "../game_components/component_magnitude.hpp"
...
namespace IRComponents {
    ...
    struct C_Gravity3D {
        ...
        C_Gravity3D()
        :   C_Gravity3D{
                C_Magnitude{kGravityMagnitudeDefault},
                C_Direction3D{kDirecton3DDown}
            }
        {
