 ...
 * File: \irreden-engine\src\game_components\component_voxel_set.hpp
...
// #include "../entity/ir_component.hpp"
...
#include "../game_systems/system_voxel_pool.hpp"
#include "../entity/entity_handle.hpp"
#include "../rendering/rendering_rm.hpp"
#include "../rendering/texture.hpp"

using namespace IRMath;
using IRRendering::ImageData;
using IRRendering::Texture2D;
using IRRendering::ResourceId;
...
namespace IRComponents {
    ...
    struct C_VoxelSetNew {
        ...
        ,   size_{size}
        {
            auto voxels = global.systemManager_->get<VOXEL_POOL>()->allocateVoxels(
            ...
            ENG_LOG_DEBUG("Allocated {} voxels", numVoxels_);
        }
        ...
        // one place?
        void onDestroy() {
            global.systemManager_->get<VOXEL_POOL>()->deallocateVoxels(
                positions_,
                positionOffsets_,
                globalPositions_,
                voxels_
            );
            ENG_LOG_DEBUG("Deallocated {} voxels", numVoxels_);
        }
