...
#include "../entity/archetype_graph.hpp"
...
namespace IRECS {
    ...
    public:
        ...
        ComponentId registerComponent(Args&&... args) {
            ...
            ENG_ASSERT(insertedIndex == toNode->length_ - 1,
        ...
        void insertDefaultComponent(EntityRecord& record) {
            ...
            ENG_LOG_DEBUG("Added default component type={} to entity={}: \n\
                \tnew row={}\n\
                \tnew type={}",
                componentType,
        ...
        void removeComponent(EntityId entity)
        {
            ...
            ENG_LOG_DEBUG("Removed component type={} from entity={} (new row={})",
        ...
        Component& getComponent(EntityId entity)
        {
            ...
            // )
            // {
            //     ENG_LOG_INFO("Attempted to retrieve non-existant component from entity");
            // }
            ENG_ASSERT(
                std::find(archetype.begin(), archetype.end(), componentType) !=
                    archetype.end(),
        ...
        std::vector<Component>& getComponentData(ArchetypeNode *node)
        {
            ...
            ENG_ASSERT(std::find(archetype.begin(), archetype.end(), componentType) != archetype.end(),
