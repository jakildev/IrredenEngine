...
namespace IRECS {
    ...
    public:
        ...
        virtual void tick(ArchetypeNode* node) override {
            ...
            EASY_BLOCK(ss.str().c_str(), IR_PROFILER_COLOR_UPDATE);
            ...
            auto paramTuple = std::make_tuple(
                ...
                std::ref(global.entityManager_->getComponentData<Components>(node))...
            );
    ...
    protected:
        ...
        void addTag() {
            m_includeTags.insert(
                global.entityManager_->getComponentType<ComponentTag>()
            );
        }
