 ...
 * File: \irreden-engine\src\systems\system_creator_chunk.cpp
...
//     {
//         ENG_LOG_INFO("Created system chunk creator");
//     }
...
//         // ENG_LOG_INFO("Distance: {}", distance & IRConstants::kTriangleDistanceDistanceBits);
...
//                 m_zLevel
//         );
//         // ENG_LOG_INFO("Mouse position: {}, {}", mouseIndex.x, mouseIndex.y);
//         ENG_LOG_INFO("Voxel hovered: {}, {}, {}",
//             m_voxelStartIndex.x,
//             m_voxelStartIndex.y,
//             m_voxelStartIndex.z
//         );
//         // ENG_LOG_INFO("Hovered triangle index: {}, {}",
...
//                 global.entityManager_->getComponent<C_MouseScroll>(
