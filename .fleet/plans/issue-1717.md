...
reconciled-through: PR #3020 merge (2026-08-22T22:28:06Z) — the Phase-0 partial on
#2091 (`Refs`, not `Closes`, so no rollup ever fired); #1640's 2026-07-09 closure
folded into the same pass
proposal-pending: **[STEWARD PROPOSAL 2026-09-09](https://github.com/jakildev/IrredenEngine/issues/1717#issuecomment-5604759627)** —
one question: how #2091's Metal residual gets routed (macOS pane / inverse host
gate / close #1717 partial). Recommendation: option 1, with the routing-gap class
fix filed separately rather than sequenced in front of it. The package states its
own no-rule fallback: #2091 stays parked, the epic stays 9/10, and the next
iteration re-audits for decay instead of re-asking. `fleet:steward-proposal`
applied 2026-09-09; removal is the re-fire edge. No `fleet:design-proposed` PR
backs it (provenance is re-validation, not flow a).
...
| #2091 | open, **parked `fleet:needs-human`** (2026-08-22, `human:approved` retained); Phase 0 DONE, Metal residual OPEN and macOS-bound | #3020 (Phase 0 only — `Refs`, not closing) | `## Plan` comment + **`issue-2091.md` (materialized 2026-09-09)** + A1 | 2026-09-09 — PR #3020 + #1640/#2307 |
