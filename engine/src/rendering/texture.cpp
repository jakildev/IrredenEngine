...
namespace IRRendering {
        ...
        m_height(height)
    {
        ...
        ENG_LOG_INFO("Created texture 2D: {}", m_handle);
    }

    Texture2D::~Texture2D() {
        ENG_LOG_INFO("Deleting texture 2D: {}", m_handle);
    ...
    :   m_width(width),
        ...
        m_depth(depth)
    {
        ENG_LOG_INFO("Creating GL Texture (3D) handle={}", m_handle);
        ENG_API->glCreateTextures(type, 1, &m_handle);
    ...
    Texture3D::~Texture3D() {
        ENG_LOG_INFO("Deleting GL Texture (3D) handle={}", m_handle);
