...
#ifndef SYSTEM_RENDERING_CANVAS_TO_FRAMEBUFFER_H
#define SYSTEM_RENDERING_CANVAS_TO_FRAMEBUFFER_H
        ...
        )
        {
            ...
            for(int i = 0; i < entities.size(); i++) {
                ...
                m_frameData.canvasZoomLevel_ =
                    global.systemManager_->get<SCREEN_VIEW>()->getTriangleZoom() *
                    zoomLevels[i].zoom_;
...
#endif /* SYSTEM_RENDERING_CANVAS_TO_FRAMEBUFFER_H */
