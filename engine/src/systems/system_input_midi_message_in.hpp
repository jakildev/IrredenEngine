...
namespace IRECS {
    ...
    public:
        ...
        ,   m_nextDeviceId{0}
        {
            ...
            ENG_LOG_INFO("Created system INPUT_MIDI_MESSAGE_IN");
        }
        ...
        )
        {
            ...
            if(m_midiChannelToDeviceMappings.contains(channelValue)) {
                ENG_LOG_ERROR("Device already exists for channel, skipping {}", channelValue);
