...
//TODO: replace initalization constants with config file.
    ...
    void World::setupLuaBindings() {
        ...
        // m_lua.registerType<C_PeriodicIdle, float, float, std::optional<float>>()
        ...
        m_lua.registerType<IRScript::LuaEntity, IRScript::LuaEntity(IREntity::EntityId)>("LuaEntity",
            "entity", &IRScript::LuaEntity::entity
        );
