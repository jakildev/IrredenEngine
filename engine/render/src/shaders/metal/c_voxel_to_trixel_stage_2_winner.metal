...
// shared body at compile time: IR_STORE_WINNER_ELECTION 1 compiles the
// cardinal winner guard, which reads the buffer-28 scratch
// c_voxel_to_trixel_stage_1_winner_resolve writes between the stages.
