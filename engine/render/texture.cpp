...
Texture2D::Texture2D(GLenum type, unsigned int width, unsigned int height, GLenum internalFormat,
                     GLint wrap, GLint filter, int alignment)
...
void Texture2D::bindImage(GLuint unit, GLenum access, GLenum format, GLint level, GLboolean layered,
                          GLint layer) const {
...
void Texture2D::subImage2D(GLint xoffset, GLint yoffset, GLsizei width, GLsizei height,
...
void Texture2D::getSubImage2D(GLint xoffset, GLint yoffset, GLsizei width, GLsizei height,
                              GLenum format, GLenum type, void *data) const {
    IR_PROFILE_FUNCTION(IR_PROFILER_COLOR_RENDER);
    glGetTextureSubImage(m_handle, 0, xoffset, yoffset, 0, width, height, 1, format, type,
                         width * height * 4, data);
}
...
Texture3D::Texture3D(GLenum type, unsigned int width, unsigned int height, unsigned int depth,
                     GLenum internalFormat, GLint wrap, GLint filter)
...
void Texture3D::subImage3D(GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type,
                           const void *data) {
    IR_PROFILE_FUNCTION(IR_PROFILER_COLOR_RENDER);
