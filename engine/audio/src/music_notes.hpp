 ...
 * File: \irreden-engine\engine\src\audio\music_notes.hpp
...
namespace IRAudio {
    ...
    constexpr bool isWhiteKey(int note) {
        ...
        return (
            noteType == kMusicNoteOffestC ||
            noteType == kMusicNoteOffestD ||
            noteType == kMusicNoteOffestE ||
            noteType == kMusicNoteOffestF ||
            noteType == kMusicNoteOffestG ||
            noteType == kMusicNoteOffestA ||
