...
namespace IRAudio {
    ...
    using IRMidiChannel = unsigned char;
    using IRMidiStatus = unsigned char;
    using IRCCData = unsigned char;
    using IRCCMessage = unsigned char;
    ...
    constexpr IRMidiChannel kNumMidiChannels = 16;

    const IRMidiStatus kMidiStatus_NOTE_OFF =                0x80;
    const IRMidiStatus kMidiStatus_NOTE_ON =                 0x90;
    const IRMidiStatus kMidiStatus_POLYPHONIC_KEY_PRESSURE = 0xA0;
    const IRMidiStatus kMidiStatus_CONTROL_CHANGE =          0xB0;
    const IRMidiStatus kMidiStatus_PROGRAM_CHANGE =          0xC0;
    const IRMidiStatus kMidiStatus_CHANNEL_PRESSURE =        0xD0;
    const IRMidiStatus kMidiStatus_PITCH_BEND =              0xE0;
    ...
    constexpr int kMajorScaleSemitoneSteps[] = {
        2, 2, 1, 2, 2, 2, 1
    };
    constexpr int kPentatonicScaleSteps[] = {
        2, 2, 3, 2, 3
    };
    constexpr int kPentatonicDorianScaleSteps[] = {
        2, 1, 4, 2, 3
    };
    constexpr int kPentatonicMinorScaleSteps[] = {
        2, 1, 4, 1, 4
    };
