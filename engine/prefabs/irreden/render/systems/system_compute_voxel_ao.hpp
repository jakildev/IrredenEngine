...
template <> struct System<COMPUTE_VOXEL_AO> {
    ...
    static SystemId create() {
        ...
        SystemId systemId =
            createSystem<C_TriangleCanvasTextures, C_CanvasAOTexture, C_TrixelCanvasRenderBehavior>(
                "ComputeVoxelAO",
                [p](const C_TriangleCanvasTextures &canvasTextures,
                    ...
                    const int groupsX =
                        IRMath::divCeil(canvasTextures.size_.x, kComputeVoxelAOGroupSize);
                    const int groupsY =
                        IRMath::divCeil(canvasTextures.size_.y, kComputeVoxelAOGroupSize);
                ...
                [p]() {
                    ...
                    p->sunFrameDataBuf_
                        ->subData(offsetof(FrameDataSun, aoEnabled_), sizeof(int), &aoEnabledFlag);
                }
            );
