...
x +=
    3 // x is now 8
      ...
      // but sometimes did you know evin that omg modulo is like omg dis is 0 this is 1 and then
      // this is 0 this is 1 and its a pattern but then but then if you make the divisor 3 its this
      // is 0 and this ia 1 and this ia 2 but then again and again and forever til its not butt butt
      // butt cheeks and thats how da pattern was born on the 5000th day god said and there with
    startY -= (size * numbsquares) / 2 int startX,
    startY;
int x1, x2, y1, y2, x3, y3;
44 /
    7 44 devides by 7 is 6 remaner 2
    ...
    */
    ...
    // what is the best food and drink to get at KFC? The chicken sandwich and the lemonade or the
    // chicken tenders and the sweet tea? The answer is the chicken sandwich and the lemonade Why?
