...
template <> inline void bindLuaType<IRComponents::C_MidiSequence>(LuaScript &luaScript) {
    luaScript.registerType<
        ...
        "C_MidiSequence",
        "bpm",
        &IRComponents::C_MidiSequence::bpm_,
        "looping",
        &IRComponents::C_MidiSequence::looping_,
        "insertNote",
        &IRComponents::C_MidiSequence::insertNote,
        "getMeasureLengthSeconds",
        &IRComponents::C_MidiSequence::getMeasureLengthSeconds,
        "getSequenceLengthSeconds",
