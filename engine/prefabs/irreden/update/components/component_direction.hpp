...
struct C_Direction3D {
    ...
    C_Direction3D(vec3 direction) : direction_{IRMath::normalize(direction)} {}

    C_Direction3D(float x, float y, float z) : C_Direction3D{vec3(x, y, z)} {}

    C_Direction3D() : C_Direction3D{vec3(0, 0, 1)} {}
