...
namespace IREntity {
    ...
    constexpr EntityId IR_MAX_ENTITIES =
        0x0000000001FFFFFF;
    constexpr EntityId IR_RESERVED_ENTITIES =
        0x00000000000000FF;
    constexpr EntityId IR_ENTITY_ID_BITS =
        0x00000000FFFFFFFF;
    constexpr EntityId IR_PURE_ENTITY_BIT =
        0x0000000100000000;
    constexpr EntityId kEntityFlagIsRelation =
        0x0000000200000000;
    constexpr EntityId kEntityFlagIsSystem =
        0x0000000400000000;
    constexpr EntityId IR_ENTITY_FLAG_MARKED_FOR_DELETION =
        0x8000000000000000; // unused i think
