...
namespace IREntity {
    ...
    template <typename Component>
    class IComponentDataImpl : public IComponentData {
    public:
        ...
        inline virtual int size() const override { return dataVector.size(); }
        ...
        virtual void moveDataAndPack(IComponentData* dest, const int indexSource) override {
            IComponentDataImpl<Component>* castedDest = static_cast<IComponentDataImpl<Component>*>(dest);
