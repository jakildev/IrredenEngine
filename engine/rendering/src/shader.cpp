...
namespace IRRender {
    ...
    std::string ShaderStage::readFileAsString(const char* filepath) {
        ...
        try {
            ...
            IRProfile::engAssert(false, "Error while reading shader file.");
        }
        return shaderCode;
    }
    ...
    void ShaderStage::checkSuccess() {
        ...
        if(!success)
        {
            ...
            IRProfile::engAssert(false, "Shader stage compilation failed.");
        }
    }
    ...
    void ShaderProgram::checkSuccess() {
        ...
        if(!success)
        {
            ...
            IRProfile::engLogFatal(infoLog.data());
            IRProfile::engAssert(false, "Shader program linking failed.");
        }
    }
