...
const std::vector<Color> kPalettePastel5 = {
    Color{0xFE, 0x93, 0x8C, 0xFF}, Color{0x89, 0xDA, 0xFF, 0xFF}, Color{0xF5, 0xCB, 0x5C, 0xFF},
    Color{0x8E, 0x7D, 0xBE, 0xFF}, Color{0xD4, 0xF5, 0xF5, 0xFF}};

const std::vector<Color> kPinkTanOrange = {Color{
...
const std::vector<Color> kPaletteSleepy = {Color{
