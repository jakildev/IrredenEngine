...
FLEET_SWEEP_SRC="$SCRIPT_DIR/fleet-sweep"
FLEET_SWEEP_DEST="$HOME/bin/fleet-sweep"
...
if [[ -f "$FLEET_SWEEP_SRC" ]]; then
    ln -sf "$FLEET_SWEEP_SRC" "$FLEET_SWEEP_DEST"
    echo "symlinked $FLEET_SWEEP_DEST -> $FLEET_SWEEP_SRC"
fi
