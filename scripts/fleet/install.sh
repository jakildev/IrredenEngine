...
FLEET_PLANS_SRC="$SCRIPT_DIR/fleet-plans"
FLEET_PLANS_DEST="$HOME/bin/fleet-plans"
...
if [[ -f "$FLEET_PLANS_SRC" ]]; then
    ln -sf "$FLEET_PLANS_SRC" "$FLEET_PLANS_DEST"
    echo "symlinked $FLEET_PLANS_DEST -> $FLEET_PLANS_SRC"
fi
