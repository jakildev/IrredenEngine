...
FLEET_CAMPAIGN_STATUS_SRC="$SCRIPT_DIR/fleet-campaign-status"
FLEET_CAMPAIGN_STATUS_DEST="$HOME/bin/fleet-campaign-status"
...
FLEET_CLIP_SRC="$SCRIPT_DIR/fleet-clip"
FLEET_CLIP_DEST="$HOME/bin/fleet-clip"
...
if [[ -f "$FLEET_CAMPAIGN_STATUS_SRC" ]]; then
    ln -sf "$FLEET_CAMPAIGN_STATUS_SRC" "$FLEET_CAMPAIGN_STATUS_DEST"
    echo "symlinked $FLEET_CAMPAIGN_STATUS_DEST -> $FLEET_CAMPAIGN_STATUS_SRC"
fi
...
if [[ -f "$FLEET_CLIP_SRC" ]]; then
    ln -sf "$FLEET_CLIP_SRC" "$FLEET_CLIP_DEST"
