...
# E2E harness
# ======================================================================
# The staged copy, the outbound stubs, the tick counter and the polling
# helpers live in lib_daemon_reload.sh, shared with the dispatcher's
# reload-inputs suite.
...
# Wait budget for wait_for / wait_for_boots.
#
