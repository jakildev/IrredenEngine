...
C.palettes = {
    ...
    forest_16          = IRMath.loadPalette("data/palettes/forest-16-1x.png"),
    graveyard_mist     = IRMath.loadPalette("data/palettes/graveyard-mist-1x.png"),
    ...
    jonk_16            = IRMath.loadPalette("data/palettes/jonk-16-1x.png"),
    ...
    peregrine16        = IRMath.loadPalette("data/palettes/peregrine16-1x.png"),
    ...
    triton_16          = IRMath.loadPalette("data/palettes/triton-16-1x.png"),
}
