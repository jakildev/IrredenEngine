...
namespace IRDefaultCreation {
    void registerLuaBindings() {
        ...
        IREngine::registerLuaBindings([](IRScript::LuaScript& luaScript) {
            ...
            luaScript.registerType<Color, Color(int, int, int, int)>("Color",
                "r", &Color::red_,
                "g", &Color::green_,
                "b", &Color::blue_,
                "a", &Color::alpha_
            );
            luaScript.registerType<ivec3, ivec3(int, int, int)>("ivec3",
                "x", &ivec3::x,
                "y", &ivec3::y,
                "z", &ivec3::z
            );
            auto vec3Type = luaScript.registerType<vec3, vec3(float, float, float)>("vec3",
                "x", &vec3::x,
                "y", &vec3::y,
                "z", &vec3::z
            );
            ...
            luaScript.registerEnum<IREasingFunctions>("IREasingFunction",
                {
            ...
            luaScript.registerType<IRScript::LuaEntity, IRScript::LuaEntity(EntityId)>("LuaEntity",
